...
public class EmployeeTests
{
    ...
    {
        var emp = new Employee("Hank", 100000, DateTime.Today.AddDays(-400));
        Assert.Equal(1, emp.Tenure);
    }
    [Fact]
    public void TestEmployeeTenureCorrect0Year()
    {
        var emp = new Employee("Hank", 100000, DateTime.Today.AddDays(-364));
    ...
    {
        var emp = new Employee("Hank", 1000, DateTime.Today.AddDays(-400));
        double net = emp.Pay();
        Assert.True (net > 0);
